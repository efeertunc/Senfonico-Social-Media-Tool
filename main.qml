...
Window {
    ...
    color: "#00000000"
    id: mainWindow
    title: qsTr("Senfonico Social Media Tool")
    ...
    QtObject{
        ...
        function maximizeRestore(){
            if(windowStatus == 0){
                ...
                bg.radius = 0
                bg.border.width = 0
                btnMaximizeRestore.btnIconSource = "restore_icon.svg"
            }
            else{
                ...
                bg.border.width = 3
                btnMaximizeRestore.btnIconSource = "maximize_icon.svg"
            }
        }
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            Label {
                ...
                y: 14
                color: "#ffffff"
                text: qsTr("Senfonico Social Media Tool")
                anchors.verticalCenter: parent.verticalCenter
        ...
        Flickable {
            ...
            GridLayout {
                ...
                CustomAppButton{
                    ...
                    font.pointSize: 9
                    Layout.alignment: Qt.AlignHCenter | Qt.AlignVCenter
                    onClicked: stackView.push("instagramUrl.qml")
                }

                CustomAppButton{
                    text: "Facebook"
                    setIcon: "facebook.svg"
                    font.pointSize: 9
                    Layout.alignment: Qt.AlignHCenter | Qt.AlignVCenter
                    onClicked: stackView.push("facebookUrl.qml")
                }
                ...
                CustomAppButton{
                    ...
                    font.pointSize: 9
                    Layout.alignment: Qt.AlignHCenter | Qt.AlignVCenter
                    onClicked: stackView.push("twitterUrl.qml")
                }
                ...
                CustomAppButton{
                    ...
                    font.pointSize: 9
                    Layout.alignment: Qt.AlignHCenter | Qt.AlignVCenter
                    onClicked: stackView.push("youtubeUrl.qml")
                }

                CustomAppButton{
                    text: "Yardım"
                    setIcon: "help_icon.svg"
                    font.pointSize: 9
                    Layout.alignment: Qt.AlignHCenter | Qt.AlignVCenter
                    onClicked: stackView.push("help.qml")
                }
            }
