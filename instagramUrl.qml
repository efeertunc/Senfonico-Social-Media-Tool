        ...
        GridLayout {
            ...
            Rectangle{
                ...
                Rectangle {
                    ...
                    backend.toGetInstagramLink(username.text,startDate.text,endDate.text)
                    }
                }
                    ...
                    CustomButton {
                        ...
                        onClicked: {
                        backend.toGetInstagramLink(username.text,startDate.text,endDate.text, kullaniciAdi.text,sifre.text)
