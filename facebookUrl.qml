        ...
        GridLayout {
            ...
            Rectangle{
                ...
                Rectangle {
                    ...
                    backend.toGetFacebookLink(username.text,startDate.text,endDate.text)
                    }
                }
